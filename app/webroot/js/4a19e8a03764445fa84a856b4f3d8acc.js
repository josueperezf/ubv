...
return false;});
$("#guardarAjax").bind("click", function (event) {$.ajax({async:true, data:$("#guardarAjax").serialize(), dataType:"html", success:function (data, textStatus) {$("fieldset table #camposDinamicos").html(data);}, type:"post", url:"\/ubv\/ubvbie12s\/addAjax"});
return false;});});
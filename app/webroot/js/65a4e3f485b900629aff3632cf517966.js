...
return false;});
$("#guardarAjax").bind("click", function (event) {$.ajax({async:true, data:josue, dataType:"html", success:function (data, textStatus) {$(" #camposDinamicos").html(data);}, type:"post", url:"\/ubv\/ubvbie12s\/addAjax"});
return false;});});
...
class TCPDF {
	...
	public function hola()
		{
		$this->Text(15,26,"holaaaaaaaaaaaaa" );
	   // $this->Cell(50, 0,"holaaaaaaaaaaa", 0, 0, 'C', 0, '', 0);
		}
	public function jl_error($imgerror,$texto)
		{
		$tipoLetra=$tipoLetra="times";
		$this->SetFont('times', 'BI', 12);
		$this->AddPage('P','A4');
		$this->Image($imgerror,76,40,60,60,'JPG','','',true,150,'',false,false,false,false,false,false);
		$this->SetY(100);
		$this->Cell(0, 0,$texto, 0, 1, 'C', 0, '', 1);
	   // $this->Cell(50, 0,"holaaaaaaaaaaa", 0, 0, 'C', 0, '', 0);
		}
	public function headermovimiento($img1,$img2,$titulo,$res,$sede,$w,$tipoLetra,$incorporacion,$origen,$destino,$numeromovimiento)
	{
		$fecha=date("d-m-Y");
		$this->Image($img1,10,10,20,20,'JPG','','',true,150,'',false,false,false,false,false,false);    
		$this->Image($img2,170,10,20,20,'JPG','','',true,150,'',false,false,false,false,false,false);
		$this->SetY(24); 
		$this->SetFont($tipoLetra, 'B', 14, '', true);
		$this->Cell(0, 0,$titulo, 0, 1, 'C', 0, '', 0);
		$this->SetFont($tipoLetra, 'B', 9, '', true);
		$this->Cell(0, 0,'Movimiento Numero: '.$numeromovimiento.'                                                                                                                                                  Fecha: '.$fecha.'       ', 0, 1, 'C', 0, '', 0);

		//$this->Cell(0, 0,'Fecha:'.$fecha.'        ', 0, 1, 'R', 0, '', 0);
		$this->SetFont($tipoLetra, 'B', 12, '', true);
		$this->Cell(0, 0,'UNIVERSIDAD BOLIVARIANA DE VENEZUELA', 1, 1, 'L', 0, '', 0);
		$this->Cell(0, 0,'UNIVERSIDAD BOLIVARIANA DE VENEZUELA - '.$sede, 1, 1, 'L', 0, '', 1);
		$this->Cell(0, 0,'ORIGEN:  '.$origen, 1, 1, 'L', 0, '', 1);
		$this->Cell(0, 0,'DESTINO:  '.$destino, 1, 1, 'L', 0, '', 1);
		$this->Cell(0, 0,'REASIGNACION POR:  '.$incorporacion, 1, 1, 'L', 0, '', 3);
		$this->SetFont($tipoLetra, 'B', 10, '', true);
		$this->Cell($w[0], 0,'Nro de Bien', 1, 0, 'L', 0, '', 1);
		$this->Cell($w[1], 0,'Codigo catalogo', 1, 0, 'L', 0, '', 1);
		$this->Cell($w[2], 0,'Descripcion', 1, 0, 'L', 0, '', 0);
		$this->Cell($w[3], 0,'Monto', 1, 0, 'L', 0, '', 1);
		$this->Ln();
	}

	public function headerinventario($img1,$img2,$titulo,$unidadAdministrati,$dependenciaUsuaria,$w,$tipoLetra,$tipoheader)
	{
		$this->Image($img1,10,10,20,20,'JPG','','',true,150,'',false,false,false,false,false,false);    
		$this->Image($img2,170,10,20,20,'JPG','','',true,150,'',false,false,false,false,false,false);
		$this->SetY(26);
		$fecha=date("d-m-Y");
		$this->SetFont($tipoLetra, 'B', 14, '', true);
		$this->Cell(0, 0,$titulo, 0, 1, 'C', 0, '', 1);
		$this->SetFont($tipoLetra, 'B', 9, '', true);
		$this->Cell(0, 0,'Fecha: '.$fecha.'       ', 0, 1, 'R', 0, '', 0);
		$this->SetFont($tipoLetra, 'B', 13, '', true);
		$this->Cell(0, 0,'UNIVERSIDAD BOLIVARIANA DE VENEZUELA', 1, 1, 'L', 0, '', 0);
		$this->Cell(0, 0,'UNIDAD ADMINISTRATIVA:  '.$unidadAdministrati, 1, 1, 'L', 0, '', 1);
		$this->Cell(0, 0,'DEPENDENCIA USUARIA:  '.$dependenciaUsuaria, 1, 1, 'L', 0, '', 1);
		$this->SetFont($tipoLetra, 'B',10,'', true);
		if ($tipoheader=='inventario') 
		{
			# code...
		...
		$this->Cell($w[1], 0,'Codigo catalogo', 1, 0, 'L', 0, '', 1);
		$this->Cell($w[2], 0,'Descripcion', 1, 0, 'L', 0, '', 0);
		$this->Cell($w[3], 0,'Unitario', 1, 0, 'L', 0, '', 1);
		$this->Cell($w[4], 0,'Total', 1, 1, 'L', 0, '', 1);	
	 	}elseif ($tipoheader=='descripcion') 
		{
		//$this->Cell($w[0], 0,'Nro de Bien', 1, 0, 'L', 0, '', 1);
		//$this->Cell($w[1], 0,'Codigo catalogo', 1, 0, 'L', 0, '', 1);
		$this->Cell($w[2]+$w[1]+$w[3]+$w[0], 0,'Descripcion', 1, 0, 'L', 0, '', 0);
		$this->Cell($w[4], 0,'cantidad', 1, 1, 'L', 0, '', 1);	
		}
	 }
	public function headerasignacion($img1,$img2,$titulo,$res,$sede,$w,$tipoLetra,$incorporacion)
	{
		$fecha=date("d-m-Y");
		$this->Image($img1,10,10,20,20,'JPG','','',true,150,'',false,false,false,false,false,false);    
		$this->Image($img2,170,10,20,20,'JPG','','',true,150,'',false,false,false,false,false,false);
		...
		$this->Cell(0, 0,'UNIVERSIDAD BOLIVARIANA DE VENEZUELA', 1, 1, 'L', 0, '', 0);
		$this->Cell(0, 0,'UNIVERSIDAD BOLIVARIANA DE VENEZUELA - '.$sede, 1, 1, 'L', 0, '', 1);
		$this->Cell(0, 0,'RESPONSABLE DEL ALMACEN:  '.$res, 1, 1, 'L', 0, '', 1);
		$this->Cell(0, 0,'INCORPORACION POR:  '.$incorporacion, 1, 1, 'L', 0, '', 1);
		$this->SetFont($tipoLetra, 'B', 10, '', true);
		$this->Cell($w[0], 0,'Nro de Bien', 1, 0, 'L', 0, '', 1);
		$this->Cell($w[1], 0,'Codigo catalogo', 1, 0, 'L', 0, '', 1);
		$this->Cell($w[2], 0,'Descripcion', 1, 0, 'L', 0, '', 0);
	...
	public function headermensual($img1,$img2,$titulo,$sede,$w,$tipoLetra,$dUsuaria)
	{
		$fecha=date("d-m-Y");
		$this->Image($img1,10,10,20,20,'JPG','','',true,150,'',false,false,false,false,false,false);    
		$this->Image($img2,170,10,20,20,'JPG','','',true,150,'',false,false,false,false,false,false);
		...
		$this->Cell(0, 0,'UNIVERSIDAD BOLIVARIANA DE VENEZUELA', 1, 1, 'L', 0, '', 0);
		$this->Cell(0, 0,'UNIVERSIDAD BOLIVARIANA DE VENEZUELA - '.$sede, 1, 1, 'L', 0, '', 1);
		$this->Cell(0, 0,'DEPENDENCIA USUARIA:  '.$dUsuaria, 1, 1, 'L', 0, '', 1);
		$this->SetFont($tipoLetra, 'B', 10, '', true);
		$this->Cell($w[0], 0,'Nro Mov', 1, 0, 'L', 0, '', 1);
		$this->Cell($w[1], 0,'Fecha', 1, 0, 'L', 0, '', 1);
		$this->Cell($w[2], 0,'Catalogo', 1, 0, 'L', 0, '', 0);
		$this->Cell($w[3], 0,'Cod Bien', 1, 0, 'L', 0, '', 1);
		$this->Cell($w[4], 0,'Descripcion', 1, 0, 'L', 0, '', 1);
		$this->Cell($w[5], 0,'Serial', 1, 0, 'L', 0, '', 1);
		$this->Cell($w[6], 0,'Concepto', 1, 0, 'L', 0, '', 1);
	...
	public function footerinventario($pensamiento1,$pensamiento2,$w,$jefe,$cedula)
	{
			$this->Cell($w[0]+$w[1]+27, 0,'Responsable Bienes Nacionales', 1, 0, '1', 0, '', 0);
			$this->Cell($w[0]+$w[1]+30, 0,'Responsable Patrimonial por Uso', 1, 0, '1', 0, '', 0);
			$this->Cell($w[3]+$w[4], 0,'Firma y Sello', 1, 0, '1', 0, '', 0);
			$this->Ln();
			$this->Cell($w[0]+$w[1]+27, 0,$jefe, 'LR', 0, '1', 0, '', 1);
			$this->Cell($w[0]+$w[1]+30, 0,'CORDINACION REGIONAL INGRESO', 'LR', 0, '1', 0, '', 0);
			$this->Cell($w[3]+$w[4], 0,'', 'LR', 0, '1', 0, '', 0);
			$this->Ln();
			$this->Cell($w[0]+$w[1]+27, 0,'C.I.: '.$cedula, 'LR', 0, '1', 0, '', 1);
			$this->Cell($w[0]+$w[1]+30, 0,'PROSECUCION Y EGRESO ESTUDIA', 'LR', 0, '1', 0, '', 0);
			$this->Cell($w[3]+$w[4], 0,'', 'LR', 0, '1', 0, '', 0);
			$this->Ln();
			$this->Cell($w[0]+$w[1]+27, 0,'JEFE DEPENDENCIA USUARIA ', 'LR', 0, '1', 0, '', 3);
			$this->Cell($w[0]+$w[1]+30, 0,'RECIBIDO POR:', 'LR', 0, '1', 0, '', 0);
			$this->Cell($w[3]+$w[4], 0,'', 'LR', 0, '1', 0, '', 0);
			$this->Ln();
			$this->Cell($w[0]+$w[1]+27, 0,'  ', 'LRB', 0, '1', 0, '', 0);
			$this->Cell($w[0]+$w[1]+30, 0,'C.I.: ', 'LRB', 0, '1', 0, '', 0);
			$this->Cell($w[3]+$w[4], 0,'', 'LRB', 0, '1', 0, '', 0);
			$this->Ln();
			$this->Cell($w[0]+$w[1]+$w[2]+$w[3]+$w[4], 0,$pensamiento1, 0, 0, 'C', 0, '', 0);
			$this->Ln();
			$this->Cell($w[0]+$w[1]+$w[2]+$w[3]+$w[4], 0,$pensamiento2, 0, 0, 'C', 0, '', 0); 
			$this->Cell(0,10,'Pagina '.$this->getAliasNumPage().'/'.$this->getAliasNbPages(),0,false,'C',0,'', 0, false, 'T', 'M');
	}
	public function footermensual($pensamiento1,$pensamiento2,$w,$jefe,$cedula)
	{
			$this->Cell($w[0]+$w[1]+$w[2]+$w[3]+$w[4], 0,'Responsable Bienes Nacionales', 1, 0, '1', 0, '', 0);
		//	$this->Cell($w[0]+$w[1]+30, 0,'Responsable Patrimonial por Uso', 1, 0, '1', 0, '', 0);
			$this->Cell($w[5]+$w[6], 0,'Firma y Sello', 1, 0, '1', 0, '', 0);
			$this->Ln();
			$this->Cell($w[0]+$w[1]+$w[2]+$w[3]+$w[4], 0,$jefe, 'LR', 0, '1', 0, '', 1);
		//	$this->Cell($w[0]+$w[1]+30, 0,'CORDINACION REGIONAL INGRESO', 'LR', 0, '1', 0, '', 0);
			$this->Cell($w[5]+$w[6], 0,'', 'LR', 0, '1', 0, '', 0);
			$this->Ln();
			$this->Cell($w[0]+$w[1]+$w[2]+$w[3]+$w[4], 0,'C.I.: '.$cedula, 'LR', 0, '1', 0, '', 1);
		//	$this->Cell($w[0]+$w[1]+30, 0,'PROSECUCION Y EGRESO ESTUDIA', 'LR', 0, '1', 0, '', 0);
			$this->Cell($w[5]+$w[6], 0,'', 'LR', 0, '1', 0, '', 0);
			$this->Ln();
			$this->Cell($w[0]+$w[1]+$w[2]+$w[3]+$w[4], 0,'JEFE DEPENDENCIA USUARIA ', 'LR', 0, '1', 0, '', 3);
		//	$this->Cell($w[0]+$w[1]+30, 0,'RECIBIDO POR:', 'LR', 0, '1', 0, '', 0);
			$this->Cell($w[5]+$w[6], 0,'', 'LR', 0, '1', 0, '', 0);
			$this->Ln();
			$this->Cell($w[0]+$w[1]+$w[2]+$w[3]+$w[4], 0,'  ', 'LRB', 0, '1', 0, '', 0);
		//	$this->Cell($w[0]+$w[1]+30, 0,'C.I.: ', 'LRB', 0, '1', 0, '', 0);
			$this->Cell($w[5]+$w[6], 0,'', 'LRB', 0, '1', 0, '', 0);
			$this->Ln();
			$this->Cell(200, 0,$pensamiento1, 0, 0, 'C', 0, '', 0);
			$this->Ln();
			$this->Cell(200, 0,$pensamiento2, 0, 0, 'C', 0, '', 0); 
			$this->Cell(0,10,'Pagina '.$this->getAliasNumPage().'/'.$this->getAliasNbPages(),0,false,'C',0,'', 0, false, 'T', 'M');
	}
	
	public function footerasignacion($pensamiento1,$pensamiento2,$w)
	{
		$this->Cell(($w[0]+$w[1]+$w[2]+$w[3])/2, 0,'Responsable del Bien', 1, 0, '1', 0, '', 0);
		$this->Cell(($w[0]+$w[1]+$w[2]+$w[3])/2, 0,'Responsable Patrimonial por Uso', 1, 0, '1', 0, '', 0);
		$this->Ln();
		$this->Cell(($w[0]+$w[1]+$w[2]+$w[3])/2, 0,'Quien entrega ', 'LR', 0, '1', 0, '', 0);
		$this->Cell(($w[0]+$w[1]+$w[2]+$w[3])/2, 0,'Quien recibe', 'LR', 0, '1', 0, '', 0);
		$this->Ln();
		$this->Cell(($w[0]+$w[1]+$w[2]+$w[3])/2, 0,'C.I.: ', 'LR', 0, '1', 0, '', 0);
		$this->Cell(($w[0]+$w[1]+$w[2]+$w[3])/2, 0,'C.I.:', 'LR', 0, '1', 0, '', 0);
		$this->Ln();
		$this->Cell(($w[0]+$w[1]+$w[2]+$w[3])/2, 0,'Cargo ', 'LR', 0, '1', 0, '', 0);
		$this->Cell(($w[0]+$w[1]+$w[2]+$w[3])/2, 0,'Cargo ', 'LR', 0, '1', 0, '', 0);
		$this->Ln();
		$this->Cell(($w[0]+$w[1]+$w[2]+$w[3])/2, 0,'  ', 'LRB', 0, '1', 0, '', 0);
		$this->Cell(($w[0]+$w[1]+$w[2]+$w[3])/2, 0,' ', 'LRB', 0, '1', 0, '', 0);
		$this->Ln();
		$this->Cell($w[0]+$w[1]+$w[2]+$w[3], 0,$pensamiento1, 0, 0, 'C', 0, '', 0);
		$this->Ln();
		$this->Cell($w[0]+$w[1]+$w[2]+$w[3], 0,$pensamiento2, 0, 0, 'C', 0, '', 0);
		$this->Cell(0, 10, 'Pagina '.$this->getAliasNumPage().'/'.$this->getAliasNbPages(), 0, false, 'C', 0, '', 0, false, 'T', 'M');
	}
	 
	public function imprimelineassindatos($numeroLineas,$faltan,$w)//para cualquiera
	{
		$columnas=count($w);
		for($L=0;$L<=$numeroLineas-$faltan; $L++)
				{
					for($C=0;$C<$columnas;$C++)
						$this->Cell($w[$C], 0,'', 1, 0, '1', 0, '', 0);
					$this->Ln();
				} 
	}
	 // la funcion imprimelineascondatos requiere que la data alla pasado primero por 
	 // la otra funcion "arraysaltolinea" que ordena la data y anexa un campo al array para la separacion
	 //de las lineas que requieren un "salto" de linea, luego imprimira la data y 
	 //retornara las lineasimpresas y la suma del campo en un arreglo
	public function imprimelineascondatos($numeroLineas,$inicio,$data,$dimenciones)
	{
/*
		echo "numeroLineas,inicio -- $numeroLineas,$inicio <br><br>";
		echo "<br><br>";
		print_r($data);
		echo count($data);
		echo "<br><br>";
...
*/
		...
		$columnas=count($w);
		$costototal=0;
		for($J=$inicio; $J <= $numeroLineas+($inicio); $J++)
				{
					//echo "numero lineas".$numeroLineas+$inicio."<br>";
					$K=0;
					for($C=0;$C< $columnas;$C++)
					{
						//echo "data ".$data[$J][$keys[$C]]."<br>";
						if($keys[$C]=='salto')$C++;
						
						if(@$data[$J]['salto']=='si')
							$this->Cell($w[$K], 0,$data[$J][$keys[$C]], 'LR', 0, '1', 0, '', 3);												
						else
							@$this->Cell($w[$K], 0,$data[$J][$keys[$C]], 'LRT', 0, '1', 0, '', 3);
						$K++;
						//echo "keys[C] ".$keys[$C]."<br>";
					if(@$keys[$C]=='unitario')@$costototal+=$data[$J]['unitario'];
					}
				...
				$retornar['costototal']=$costototal;
				$retornar['lineasImpresas']=$lineas;
				return $retornar;
	}
	public function contarInventario($data,$auxiliardata)
	{
		//echo "data  ".$data."<br>";
		//print_r($data);
		$I=0;
		$acontar= array();
		foreach ($auxiliardata as $aqui2)
		{
			//print_r($aqui);
		//	echo"<br>$aqui2<br>";
			foreach ($data as $aqui)
			{
				//echo"----------  aqui $aqui <br>";
				if($aqui == $aqui2)
					{

					//	echo "sumar $aqui2 con $aqui<br>";
						$acontar[$I]['descripcion']=$aqui2;
						@$acontar[$I]['cantidad']=$acontar[$I]['cantidad']+1;
						$acontar[$I]['salto']='no';
						$acontar[$I]['unitario']=0;
	...
	public function arraysaltolinea($SL,$caracteres,$data)
	{
		$total=count($data);
		$texto='';
		$salto='';
		...
		if(($columnas==0) || ($total==0) || ($SL==0))return FALSE;
		else
		{	
			$keys=array_keys($data[0]);
			for($P=0;$P<$SL;$P++)
			{
				...
				{ 
					$salto='0';
					for($C=0;$C<= $columnas-1;$C++)//comparamos si requiere salto de linea
					{
						
						$largo=strlen($data[$L][$keys[$C]]);
						if($data[$L]['salto']=="si"){$filaTemporal1[$S]['salto']="si";}
						if($data[$L]['salto']=="no"){$filaTemporal1[$S]['salto']="no";}
						if($largo <= $caracteres[$C])
						{
							$filaTemporal1[$S][$keys[$C]]=$data[$L][$keys[$C]];
							if($data[$L]['salto']=="si")$filaTemporal1[$S]['salto']="si";
							else $filaTemporal1[$S]['salto']="no";
							$filaTemporal1[$S+1][$keys[$C]]='';
							$filaTemporal1[$S+1]['salto']='si';
						}
						else
						{   
							$salto='1';
							$PS=$S+$salto;
							$texto =$data[$L][$keys[$C]];
							$primero=substr($texto,0,strrpos(substr($texto,0,$caracteres[$C])," "));
							$segundo=substr($texto,strlen($primero), strlen($texto));
							$filaTemporal1[$S][$keys[$C]]=$primero;
							$filaTemporal1[$PS][$keys[$C]]=$segundo;
							$filaTemporal1[$S]['salto']="si";
							$filaTemporal1[$PS]['salto']="no";
						}
					}
					$S++;
					if($salto=='1')$S++;
				}
					$total=count($filaTemporal1);
					$data=$filaTemporal1;
			}
			return $data;
		}
